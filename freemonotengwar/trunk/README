...
The FreeMonoTengwar font is based on the FreeMono.sfd of the
2009-01-04 GNU FreeFont. It includes everything from FreeMono.sfd
...
advanced features to the Personal Use Area. These ligatures have been
